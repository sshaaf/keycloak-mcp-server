...
If your Keycloak uses a certificate from a trusted CA (Let's Encrypt, DigiCert, etc.), **no additional configuration is needed**.
...
Based on [your tutorial](https://shaaf.dev/post/2023-09-08-install-keycloak-operator-kubernetes-basic-tutorial/), here's the complete Keycloak setup:
