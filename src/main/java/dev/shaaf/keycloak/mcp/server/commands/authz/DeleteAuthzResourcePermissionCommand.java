...
@ApplicationScoped
@RegisteredCommand
public class DeleteAuthzResourcePermissionCommand extends AbstractCommand {
    ...
    public KeycloakOperation getOperation() {
        return KeycloakOperation.DELETE_AUTHZ_RESOURCE_PERMISSION;
    }
    ...
    public String getDescription() {
        return "Delete a resource permission by id";
    }

    @Override
    public String execute(JsonNode params) {
        return authz.deleteResourcePermission(
