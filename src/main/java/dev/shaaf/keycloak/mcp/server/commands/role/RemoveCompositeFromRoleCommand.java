...
@ApplicationScoped
@RegisteredCommand
public class RemoveCompositeFromRoleCommand extends AbstractCommand {
    ...
    public KeycloakOperation getOperation() {
        return KeycloakOperation.REMOVE_COMPOSITE_FROM_ROLE;
    }
    ...
    public String getDescription() {
        return "Remove a composite role from a realm role";
    }
