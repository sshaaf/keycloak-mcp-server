...
@ApplicationScoped
@RegisteredCommand
public class GetSubGroupsCommand extends AbstractCommand {
    ...
    public KeycloakOperation getOperation() {
        return KeycloakOperation.GET_SUBGROUPS;
    }
    ...
    public String getDescription() {
        return "List direct subgroups of a group (one level)";
    }
    ...
    public String execute(JsonNode params) throws Exception {
        ...
        return toJson(groupService.getSubGroups(realm, groupId));
    }
}
