...
@ApplicationScoped
@RegisteredCommand
public class GetClientScopesCommand extends AbstractCommand {
    ...
    public KeycloakOperation getOperation() {
        return KeycloakOperation.GET_CLIENT_SCOPES;
    }
    ...
    public String getDescription() {
        return "Get all client scopes in a realm";
    }

    @Override
    public String execute(JsonNode params) throws Exception {
        String realm = requireString(params, "realm");
        return toJson(clientScopeService.getClientScopes(realm));
    }
}
