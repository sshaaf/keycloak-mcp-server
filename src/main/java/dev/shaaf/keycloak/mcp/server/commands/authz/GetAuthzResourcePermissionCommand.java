...
@ApplicationScoped
@RegisteredCommand
public class GetAuthzResourcePermissionCommand extends AbstractCommand {
    ...
    public KeycloakOperation getOperation() {
        return KeycloakOperation.GET_AUTHZ_RESOURCE_PERMISSION;
    }
    ...
    public String getDescription() {
        return "Get a resource permission by id";
    }

    @Override
    public String execute(JsonNode params) throws Exception {
        ResourcePermissionRepresentation r = authz.getResourcePermission(
