...
@ApplicationScoped
@RegisteredCommand
public class RemoveDefaultClientScopeCommand extends AbstractCommand {
    ...
    public KeycloakOperation getOperation() {
        return KeycloakOperation.REMOVE_DEFAULT_CLIENT_SCOPE;
    }
    ...
    public String getDescription() {
        return "Remove a default client scope from realm";
    }
    ...
    public String execute(JsonNode params) throws Exception {
        ...
        return clientScopeService.removeDefaultClientScope(realm, clientScopeId);
    }
}
