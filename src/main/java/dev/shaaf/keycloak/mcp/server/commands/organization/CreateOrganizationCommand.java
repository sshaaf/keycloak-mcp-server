...
@ApplicationScoped
@RegisteredCommand
public class CreateOrganizationCommand extends AbstractCommand {
    ...
    public KeycloakOperation getOperation() {
        return KeycloakOperation.CREATE_ORGANIZATION;
    }

    @Override
    public String[] getRequiredParams() {
        return new String[]{"realm", "organization"};
    }

    @Override
    public String getDescription() {
        return "Create an organization (organization: OrganizationRepresentation JSON).";
    }
