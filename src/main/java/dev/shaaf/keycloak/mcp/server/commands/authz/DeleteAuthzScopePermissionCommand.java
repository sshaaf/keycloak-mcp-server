...
@ApplicationScoped
@RegisteredCommand
public class DeleteAuthzScopePermissionCommand extends AbstractCommand {
    ...
    public KeycloakOperation getOperation() {
        return KeycloakOperation.DELETE_AUTHZ_SCOPE_PERMISSION;
    }
    ...
    public String getDescription() {
        return "Delete a scope-based permission by id";
    }

    @Override
    public String execute(JsonNode params) {
        return authz.deleteScopePermission(
