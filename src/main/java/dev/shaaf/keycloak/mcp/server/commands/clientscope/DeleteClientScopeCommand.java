...
@ApplicationScoped
@RegisteredCommand
public class DeleteClientScopeCommand extends AbstractCommand {
    ...
    public KeycloakOperation getOperation() {
        return KeycloakOperation.DELETE_CLIENT_SCOPE;
    }
    ...
    public String execute(JsonNode params) throws Exception {
        ...
        return clientScopeService.deleteClientScope(realm, clientScopeId);
    }
}
