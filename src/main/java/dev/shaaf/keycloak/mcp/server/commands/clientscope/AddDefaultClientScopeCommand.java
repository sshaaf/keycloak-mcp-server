...
@ApplicationScoped
@RegisteredCommand
public class AddDefaultClientScopeCommand extends AbstractCommand {
    ...
    public KeycloakOperation getOperation() {
        return KeycloakOperation.ADD_DEFAULT_CLIENT_SCOPE;
    }
    ...
    public String getDescription() {
        return "Add a client scope as default for realm";
    }
    ...
    public String execute(JsonNode params) throws Exception {
        ...
        return clientScopeService.addDefaultClientScope(realm, clientScopeId);
    }
}
