...
@ApplicationScoped
@RegisteredCommand
public class AddOptionalClientScopeCommand extends AbstractCommand {
    ...
    public KeycloakOperation getOperation() {
        return KeycloakOperation.ADD_OPTIONAL_CLIENT_SCOPE;
    }
    ...
    public String getDescription() {
        return "Add a client scope as optional for realm";
    }
    ...
    public String execute(JsonNode params) throws Exception {
        ...
        return clientScopeService.addOptionalClientScope(realm, clientScopeId);
    }
}
