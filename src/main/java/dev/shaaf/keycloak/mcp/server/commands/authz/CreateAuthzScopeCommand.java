...
@ApplicationScoped
@RegisteredCommand
public class CreateAuthzScopeCommand extends AbstractCommand {
    ...
    public KeycloakOperation getOperation() {
        return KeycloakOperation.CREATE_AUTHZ_SCOPE;
    }

    @Override
    public String[] getRequiredParams() {
        return new String[]{"realm", "clientId", "scope"};
    }

    @Override
    public String getDescription() {
        return "Create an authorization scope";
    }

    @Override
    public String execute(JsonNode params) throws Exception {
        return authz.createScope(
