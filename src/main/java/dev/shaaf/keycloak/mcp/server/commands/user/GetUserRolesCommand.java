...
@ApplicationScoped
@RegisteredCommand
public class GetUserRolesCommand extends AbstractCommand {
    ...
    public KeycloakOperation getOperation() {
        return KeycloakOperation.GET_USER_ROLES;
    }
    ...
    public String getDescription() {
        return "Get roles assigned to a user";
    }
    ...
    public String execute(JsonNode params) throws Exception {
        ...
        return toJson(userService.getUserRoles(realm, userId));
    }
}
