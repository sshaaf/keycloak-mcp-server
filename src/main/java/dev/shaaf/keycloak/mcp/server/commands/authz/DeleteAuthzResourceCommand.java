...
@ApplicationScoped
@RegisteredCommand
public class DeleteAuthzResourceCommand extends AbstractCommand {
    ...
    public KeycloakOperation getOperation() {
        return KeycloakOperation.DELETE_AUTHZ_RESOURCE;
    }
    ...
    public String getDescription() {
        return "Delete a protected resource";
    }

    @Override
    public String execute(JsonNode params) {
        return authz.deleteResource(
